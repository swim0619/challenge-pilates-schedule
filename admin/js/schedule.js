    ...
    <div class="week-grid-wrap">
      <div class="week-grid">
        ${days.map((d) => {
          ...
          return `
            <div class="week-col ${KOREAN_HOLIDAYS[dateStr] ? 'holiday' : ''}" data-date-cell="${dateStr}">
              <h4>${DAY_LABELS[d.getDay()]} ${d.getMonth() + 1}/${d.getDate()}${isToday ? ' · 오늘' : ''}${KOREAN_HOLIDAYS[dateStr] ? `<span class="holiday-label">${KOREAN_HOLIDAYS[dateStr]}</span>` : ''}</h4>
              ${dayClasses.length === 0
